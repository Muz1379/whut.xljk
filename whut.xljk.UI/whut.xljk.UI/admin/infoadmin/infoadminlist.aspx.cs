...
{
    public partial class infoadminlist : System.Web.UI.Page, ISingleGridPage
    {
        ...
        {
            return "~/admin/infoadmin/infoadminadd.aspx";
        }
        ...
        public string GetEditUrl()
        {
            ...
            return String.Format("~/admin/infoadmin/infoadmindetail.aspx?id={0}&name={1}", keys[0], HttpUtility.UrlEncode(keys[1].ToString()));
        }
