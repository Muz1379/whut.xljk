<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="infoadmindetail.aspx.cs" Inherits="EmptyProjectNet45_FineUI.admin.infoadmin.infoadmindetail" %>
        ...
        <f:Form ID="SimpleForm1"  ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                <f:FormRow ID="FormRow1">
                    <Items>
                        <f:TextBox ID="name" runat="server" Label="账号姓名" Enabled="false">
                        </f:TextBox>
                    </Items>
                    <Items>
                        <f:TextBox ID="reaname" runat="server" Label="真实姓名" Enabled="false">
                        </f:TextBox>
                    </Items>
                </f:FormRow>
                ...
                <f:FormRow>
                    <Items>
                        <f:Button ID="add" Text="提交" OnClick="add_Click" runat="server"></f:Button>
                    </Items>
                </f:FormRow>
            </Rows>
        </f:Form>
